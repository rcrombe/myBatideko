                            ...
                            function() {
                                ...
                                if (x == 1) {
                                    ...
                                    var body = {
                                        ...
                                        'company_id': ass.chantier_id,
                                        'journee': ass.journee,
                                        'event_start_time': res[0],
                                        'event_end_time': res[1]
                                    };
                                ...
                                //console.log(assSendList);
                                //console.log(body)
                                var options = {
                                    url: 'https://api.mytime.fr/schedule?event_type=WORK',
                                    headers: {
                                        'Authorization': TOKEN_TYPE + ' ' + TOKEN,
                                        'Content-Type': 'application/x-www-form-urlencoded'
                                    },
...
var timer = setInterval(checkAlive, 600000);
